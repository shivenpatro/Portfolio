...
// ExtendMaterial function with proper typing
function extendMaterial(
  BaseMaterial: new (params?: THREE.MaterialParameters) => THREE.Material,
  cfg: any
  ...
  if ('color' in defaults) uniforms.diffuse.value = (defaults as any).color;
  ...
  if ("envMapIntensity" in defaults)
    uniforms.envMapIntensity.value = (defaults as any).envMapIntensity;
...
const DirLight: FC<DirLightProps> = ({
  position,
  color,
}) => {
